...
function Editinfomodal({handleEditFunc, selfData , closeModal}) {
  ...
  return (
    <div className='mt-5 w-full h-[260px] overflow-y-auto'>
        ...
        <div className="w-full mb-4">
            ...
            <br/>
            <textarea value={data.headline} onChange={(e)=>{onChangeHandle(e, 'headline')}} className='p-2 mt-1 w-full border-1 rounded-md '  cols={10} row={3}></textarea>
        </div>
         <div className="w-full mb-4">
